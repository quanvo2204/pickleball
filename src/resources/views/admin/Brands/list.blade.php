        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('brand.create') }}" class="btn btn-primary">New Category</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <div class="card-title">
                        <button onclick="window.location.href='{{ route('brand.show') }}' "
                            class="btn btn-default btn-sm">Back</button>
                    </div>
                    <div class="card-tools">
                        <form action="{{ route('brand.show') }}" method="GET">
    ...
    <script>
        $(document).ready(function() {
            $('.delete-brand').on('click', function(e) {
                ...
                let brandId = $(this).data('id'); // lấy giá trị của thuộc tính data-id
