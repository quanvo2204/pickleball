                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="{{ $pages->slug }}" name="slug" id="slug" class="form-control" placeholder="Slug">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-3">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <select name="status" id="status" class="form-control">
                                        <option {{ ($pages->status == 1) ? 'selected' : '' }} value="1">Active</option>
                                        <option {{ ($pages->status == 0) ? 'selected' : '' }} value="0">Block</option>
                                    </select>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    $("#pageForm").submit(function(event) {
        ...
        $.ajax({
            url: `{{ route("page.update", $pages->id) }}`, // Đảm bảo route đúng
            type: 'PUT',
