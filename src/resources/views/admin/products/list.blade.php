                    ...
                    <tbody>
                        @foreach ($products as $key => $item)
                            ...
                            <tr>
                                <td>{{$key+1}}</td>
                                <td>
                                    @if (!empty($productImage->image) && file_exists(public_path().'/uploads/product/small/'.$productImage->image))
                                        <img src="{{asset('uploads/product/small/'.$productImage->image)}}" class="img-thumbnail" style="width: 50px; height: 40px;">

                                    @else
                                        <img src="{{asset('uploads/product/small/default_product.jpg')}}" class="img-thumbnail" width="50" >
                                    @endif
                                </td>
                                ...
                                <td>
                                    ...
                                    {{-- Delete --}}
                                    <a href="" data-id="{{ $item->id}}" class="text-danger w-4 h-4 mr-1 delete-product">
