                                ...
                                <div class="col-md-12">
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('shipping.edit', $shippingCharge->id)}}"  class="text-success w-4 h-4 mr-1 ">
                                                ...
                                                <a href="javascript:void(0);" onclick="deleteItem({{ $shippingCharge->id}})"
                                                    class="text-danger w-4 h-4 mr-1 delete-shipping" data-id="{{ $shippingCharge->id }}">
...
@section('js')
    <script>
        $("#shippingForm").submit(function(event) {
            ...
            $.ajax({
                url: `{{ route('shipping.store') }}`, // Đảm bảo route đúng
                type: 'POST',
