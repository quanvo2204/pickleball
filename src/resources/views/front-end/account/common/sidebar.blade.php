<ul id="account-panel" class="nav nav-pills flex-column" >
    ...
    <li class="nav-item">
        <a href="{{ route('account.order')}}"  class="nav-link font-weight-bold" role="tab" aria-controls="tab-register" aria-expanded="false"><i class="fas fa-shopping-bag"></i>
            My Orders
        </a>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
        <a href="{{ route('account.showChangePassword')}}"  class="nav-link font-weight-bold" role="tab" aria-controls="tab-register" aria-expanded="false"><i class="fas fa-lock"></i>
            Change Password
        </a>
    </li>
    <li class="nav-item">
